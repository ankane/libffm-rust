...
mod tests {
    ...
    fn test_empty_line() {
        ...
        assert_eq!(
            err.to_string(),
            "FFM error (line: 2): expected line to start with int".to_string()
        );
    }
    ...
    fn test_parse_line() {
        ...
        assert_eq!(
            err.to_string(),
            "FFM error (line: 1): expected line to start with int".to_string()
        );
    }
    ...
    fn test_parse_node() {
        ...
        assert_eq!(
            err.to_string(),
            "FFM error (line: 1, node: 1, token: 1): expected int".to_string()
        );
    }
    ...
    fn test_too_few_tokens() {
        ...
        assert_eq!(
            err.to_string(),
            "FFM error (line: 1, node: 1, token: 3): missing token".to_string()
        );
    }
    ...
    fn test_too_many_tokens() {
        ...
        assert_eq!(
            err.to_string(),
            "FFM error (line: 1, node: 1, token: 4): too many tokens".to_string()
        );
    }
}
